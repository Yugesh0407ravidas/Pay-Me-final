...
export default function Middlecomp() {
    ...
    return <div className=' sm:w-1/3 m-4 p-4 bg-white rounded-xl shadow-lg transition-all	'>
        ...
        <div onClick={() => { nav("/transfer") }} className='transition-all	 m-4 flex flex-col items-center justify-center bg-cyan-200 rounded-lg shadow-md group transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 cursor-pointer	'>
        ...
        <div onClick={() => { nav("/transfer") }} className='m-4 flex flex-col items-center justify-center bg-cyan-200 rounded-lg shadow-md group transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 cursor-pointer	'>
        ...
        <div>
            ...
            <div className='flex flex-wrap justify-evenly '>
                ...
                <Service text={"Electricity"} d={"m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z"}></Service>
